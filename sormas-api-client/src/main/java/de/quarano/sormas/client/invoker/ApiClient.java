...
import de.quarano.sormas.client.invoker.auth.ApiKeyAuth;
import de.quarano.sormas.client.invoker.auth.OAuth;

@javax.annotation.Generated(value = "io.swagger.codegen.v3.generators.java.JavaClientCodegen",
		date = "2020-07-09T17:56:16.099120+02:00[Europe/Berlin]")
@Component("de.quarano.sormas.client.invoker.ApiClient")
public class ApiClient {
	...
	private String basePath = "https://sormas-docker-test.com/sormas-rest";
	...
	protected void init() {
		...
		authentications.put("http-basic", new HttpBasicAuth());
